# CourseTechGuide: технический справочник по формату уроков

Этот файл — **технический справочник**: как устроены слайды, квизы, `check`‑проверки, медиа и навигация.

Если вам нужны **правила оформления, педагогики и структуры “Теория → Практика → …”**, смотрите `LessonMethodGuide.md`.

Для подробных справочников смотрите папку `Docs/`.
...
**Рекомендуемый стандарт для уроков курса:** минимум 22 слайда на урок (обычно это \(21+\) разделитель `---` на файл).
...
- **Избегайте огромных проверок:** вместо “одного большого задания” делайте несколько маленьких шагов (2–5) с отдельными `check`‑блоками. Это упрощает отладку, повышает прозрачность прогресса и снижает ложные провалы.
...
- [LessonMethodGuide.md](LessonMethodGuide.md) — правила оформления и педагогический подход
