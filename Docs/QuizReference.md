...
- не делайте правильный ответ систематически самым длинным или самым подробным вариантом;
- выравнивайте варианты по длине и уровню конкретности: дистракторы должны выглядеть правдоподобно, но оставаться неверными;
