...
- **lessons/m3/** - содержит 2 урока модуля 3: условные операторы и циклы
...
# Содержание уроков модуля m3

## 1. Условные операторы и логические выражения
- Условные операторы (if, else if, else)
- Логические выражения и операторы
- Сравнение значений
- Блоки `check` для проверки знаний

## 2. Циклы и повторяющиеся действия
